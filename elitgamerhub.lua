...
function toTargetP(CFgo)
    ...
    function TweenBoat(CFgo)
        ...
        local tween_s = game:service"TweenService"
        local info = TweenInfo.new((game:GetService("Players")["LocalPlayer"].Character.HumanoidRootPart.Position - CFgo.Position).Magnitude/325, Enum.EasingStyle.Linear)
        tween = tween_s:Create(game.Playe…"
 https://raw.githubusercontent.com/Tungwiboo/RikkaHub/main/RikkaHub.txt#:~:text=%2D%2D%5B%5B%20%20%0A%20%20___%20%20%20%20%20%20%20%20_%20%20%20%20%20%20%20_____,end%20end%20end%20end